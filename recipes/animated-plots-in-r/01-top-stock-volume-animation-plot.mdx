...
You can also use [this dataset](/recipes/animated-plots-in-r/dataset/most_traded_stocks.csv) for this task, it is the same with the data that we called from the API, and it's accessible on [Sectors](https://sectors.app).
...
![Most Traded Stocks in 2024](/recipes/animated-plots-in-r/images/most_traded_stocks.gif)
