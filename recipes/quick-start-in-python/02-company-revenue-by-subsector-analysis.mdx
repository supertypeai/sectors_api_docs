...
sidebarTitle: "0.2 Company Revenue by Subsector Analysis"
...
Using this API we will get the data we need and do some nice visualization on it. You should take a look at [List All Subsectors Recipe](./01-list-all-subsectors) also if you need a simple example of data exploration on Sectors API.
