...
- **Mineral**
  - **Mineral Companies**
    - `GET v2/mineral/mineral-companies/`
    - `GET v2/mineral/mineral-companies/{{company_id}}/`
    - `GET v2/mineral/mineral-companies/{{company_id}}/performance/`
    - `GET v2/mineral/mineral-companies/{{ticker}}/financials/`
  - **Mining Data**
    - `GET v2/mineral/mining-sites/`
    - `GET v2/mineral/production/total/`
    - `GET v2/mineral/resources-reserves/`
  - **Commodities & Trade**
    - `GET v2/mineral/commodities/{{commodity_name}}/price/`
    - `GET v2/mineral/trade/exports/`
    - `GET v2/mineral/global-commodity/`
    - `GET v2/mineral/sales-destination/`
  - **Licenses & News**
    - `GET v2/mineral/licenses/`
    - `GET v2/mineral/mining-license-auctions/`
    - `GET v2/mineral/news/`
