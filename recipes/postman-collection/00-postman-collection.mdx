...
1. **Download the Postman Collection**:
   - Click here [Postman Collection](/recipes/postman_collection/json/Supertype API 02-2025 v1.1.postman_collection.json) and download the latest version of the Postman collection file.
...
3. **Import the Collection**:
   ...
   - Select the downloaded `Supertype API 02-2025 v1.1.postman_collection.json` file and click **Open**.
...
1. **Collection Variables**: These are shared across all requests in the collection. Examples include:
   - `{{environment}}`: The base URL for the API.
...
The collection currently uses a placeholder API key. To use your own API key:

1. Open the collection in Postman.
2. Go to the **Variables** tab in the collection settings.
3. Locate the `{{api_key}}` variable.
4. Replace the current value with your API key.
5. Save the changes.
