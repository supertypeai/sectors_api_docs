...
sidebarTitle: "0.0 Microsoft Excel"
...
- Click on "Get Data" > "From Other Sources" > "From Web".
  ...
  ![Step_1](/recipes/non-programmatical-tools/00-excel/images/step1.png)
...
- Enter the URL of the API endpoint.
  ...
  ![Step_2](/recipes/non-programmatical-tools/00-excel/images/step2.png)

- If it gives you this kind of issue:

  ![Credentials Error](/recipes/non-programmatical-tools/00-excel/images/error1.png)
...
- Click `Back` and let's change the API url to `https://api.sectors.app/health/`. Leave the header and your API key as it is, as this is necessary.
  ...
  ![Step_3](/recipes/non-programmatical-tools/00-excel/images/step3.png)
  ...
  ![Step_4](/recipes/non-programmatical-tools/00-excel/images/step4.png)
  ...
  ![Step_5](/recipes/non-programmatical-tools/00-excel/images/step5.png)
...
- Finally, our very first query connection to the Sectors API is successful, and we shall proceed to the next step.
  ![Step_6](/recipes/non-programmatical-tools/00-excel/images/step6.png)
...
- Convert the JSON data to a table:
  ...
  ![Step_7](/recipes/non-programmatical-tools/00-excel/images/step7.png)
...
- Expand the main JSON object:
  ...
  Finally, click "OK".
  ![Step_8](/recipes/non-programmatical-tools/00-excel/images/step8.png)

  The current state of the Power Query should look like this:
  ![Step_9](/recipes/non-programmatical-tools/00-excel/images/step9.png)
  ...
  ![Result_1](/recipes/non-programmatical-tools/00-excel/images/result1.png)
...
If your JSON data contains nested objects or arrays, you will see in the preview columns with `[Record]` or `[List]` entries. If you leave them as they are, it will get displayed as a string after you load the query.
    ...
    ![Error_2](/recipes/non-programmatical-tools/00-excel/images/error2.png)
...
- Our starting point would look like this:
  ...
  ![Step_10](/recipes/non-programmatical-tools/00-excel/images/step10.png)
...
- Handling records is relatively easier, you simply need to click on one of the row which you want to expand, like the one next to `overview`. It should automatically add another step which is to called `Navigation`
  ![Step_11](/recipes/non-programmatical-tools/00-excel/images/step11.png)
  ...
  ![Step_12](/recipes/non-programmatical-tools/00-excel/images/step12.png)
  ...
  ![Step_13](/recipes/non-programmatical-tools/00-excel/images/step13.png)
  ...
  ![Step_14](/recipes/non-programmatical-tools/00-excel/images/step14.png)
...
- Handling list is slightly more "nested" but they are pretty much the same. As a reference, the `peers` JSON structure look like this:
  ...
  ![Step_15](/recipes/non-programmatical-tools/00-excel/images/step15.png)
  We simply need to click on the entry we need to expand, which is `companies`.

  ![Step_16](/recipes/non-programmatical-tools/00-excel/images/step16.png)

  Once we are here, we have reached the desired stopping point, and we can convert this `to table`.

  ![Step_17](/recipes/non-programmatical-tools/00-excel/images/step17.png)

  And as always, once it's detected as a table, we can now expand the whole thing:

  ![Step_18](/recipes/non-programmatical-tools/00-excel/images/step18.png)
  ...
  ![Step_19](/recipes/non-programmatical-tools/00-excel/images/step19.png)
  ...
  ![Final](/recipes/non-programmatical-tools/00-excel/images/final.png)
...
![Refresh](/recipes/non-programmatical-tools/00-excel/images/refresh.png)
