...
```
GET https://api.sectors.app/v1/subsector/report/{sector}/?sections=market_cap
```

And once we call it using our function,

```python
url = f"https://api.sectors.app/v1/subsector/report/{sectors[0]}/?sections=market_cap"
...
for i in range(3):
  url = f"https://api.sectors.app/v1/subsector/report/{sectors[i]}/?sections=market_cap"
  market_cap = fetch_data(url)
...
```
GET https://api.sectors.app/v1/idx-total/
```
...
```
GET https://api.sectors.app/v1/subsector/report/{sector}/?sections=valuation
```

Calling it using our function,

```python
url = f"https://api.sectors.app/v1/subsector/report/financing-service/?sections=valuation"
...
for i in range(3):
  url = f"https://api.sectors.app/v1/subsector/report/{sectors[i]}/?sections=valuation"
  valuation = fetch_data(url)
  df = pd.DataFrame(valuation["valuation"]["historical_valuation"])
  df["Sector"] = valuation["sub_sector"]
...
```
GET https://api.sectors.app/v1/subsector/report/{sector}/?sections=companies
```

Call it using our function,

```python
url = f"https://api.sectors.app/v1/subsector/report/{sectors[0]}/?sections=companies"
