...
```json 204
// no content. consider adjust start and end query params values
```
...
<ResponseField name="payload" type="IDXMarketCapData[]" required>
  <Expandable title="properties">
    <ResponseField name="IDXMarketCapData.date" type="string" required>
      The date of the total IDX market capitalization data.
    </ResponseField>

    <ResponseField name="IDXMarketCapData.idx_total_market_cap" type="integer" required>
