...
---
<Warning>
**Discontinued:** This v1 endpoint was discontinued on **2026-05-11**. All /v1/* requests now return HTTP 410 Gone. Please migrate to the equivalent [v2 API](/api-references/v2/indonesia/transaction/idx-total) and see the [Migration Guide](/get-started/v2/migration-guide) for details.
</Warning>
