...
<ResponseField name="payload" type="DailyTransactionData[]" required>
  <Expandable title="properties">
    ...
    <ResponseField name="DailyTransactionData.close" type="integer" required>
      The closing price of the given ticker in IDR.
    </ResponseField>

    <ResponseField name="DailyTransactionData.volume" type="integer" required>
      The transaction volume of the given ticker.
    </ResponseField>

    <ResponseField name="DailyTransactionData.market_cap" type="integer" required>
