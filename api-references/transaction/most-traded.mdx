...
<ResponseField name="<date>" type="TradeData[]" required>
  <Expandable title="properties">
    <ResponseField name="symbol" type="symbol" required>
      The ticker symbol of the traded stock
    </ResponseField>
    <ResponseField name="volume" type="int" required>
