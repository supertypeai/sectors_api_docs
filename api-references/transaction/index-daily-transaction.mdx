...
api: "GET /v1/index-daily/{index_code}/"
description: "Return daily transaction data of a given index code on a certain interval  (**up to 90 days**)"
---
<Warning>
**Discontinued:** This v1 endpoint was discontinued on **2026-05-11**. All /v1/* requests now return HTTP 410 Gone. Please migrate to the equivalent [v2 API](/api-references/v2/indonesia/transaction/index-daily) and see the [Migration Guide](/get-started/v2/migration-guide) for details.
</Warning>
