...
<ResponseField name="overview" type="object">
  An overview of the company's listing details and key metrics
</ResponseField>

<ResponseField name="valuation" type="object">
  Valuation metrics and related information of the company
</ResponseField>

<ResponseField name="future" type="object">
  Future forecasts related to the company
</ResponseField>

<ResponseField name="financials" type="object">
  Historical financials and key financial ratios of the company
</ResponseField>
...
<ResponseField name="management" type="object">
  Key management and their shareholdings
</ResponseField>

<ResponseField name="ownership" type="object">
  Ownership details including major shareholders and transaction
</ResponseField>

<ResponseField name="peers" type="object">
  Information about the company's peers
</ResponseField>
