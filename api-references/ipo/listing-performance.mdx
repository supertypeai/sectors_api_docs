...
<ResponseField name="chg_7d" type="float" required>
  The price change in the last 7 days.
</ResponseField>
<ResponseField name="chg_30d" type="float" required>
  The price change in the last 30 days.
</ResponseField>
<ResponseField name="chg_90d" type="float" required>
  The price change in the last 90 days.
</ResponseField>
<ResponseField name="chg_365d" type="float" required>
