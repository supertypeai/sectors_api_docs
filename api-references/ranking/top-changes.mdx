...
<ResponseField name="data" type="Data">
  <Expandable title="properties">
    ...
    <ResponseField name="Data.sector" type="string">
      The top company sector
    </ResponseField>
    <ResponseField name="Data.symbol" type="string">
      The top company symbol
    </ResponseField>
    <ResponseField name="Data.sub_sector" type="string">
      The top company sub_sector
    </ResponseField>
    <ResponseField name="Data.last_change" type="float">
      The top company last change
    </ResponseField>
