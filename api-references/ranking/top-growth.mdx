...
api: "GET /v1/companies/top-growth/"
...
<Warning>
**Deprecation Notice:** This v1 endpoint will be discontinued at the end of March 2026. Please migrate to the [v2 Companies Screener](/api-references/v2/indonesia/companies) using the `order_by` parameter. See the [Migration Guide](/get-started/v2/migration-guide#3-top-companies-by-growth) for details.
</Warning>
