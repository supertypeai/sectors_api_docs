...
description: "Return a list of top tickers in a given year based on certain classification (dividend yield, total dividend, revenue, earnings, or market cap)"
---
...
<ResponseField name="pb" type="PBData[]">
  <Expandable title="properties">
    ...
    <ResponseField name="PBData.pb" type="int" required>
...
<ResponseField name="pe" type="PEData[]">
  <Expandable title="properties">
    ...
    <ResponseField name="PEData.pe" type="int" required>
...
<ResponseField name="ps" type="PSData[]">
  <Expandable title="properties">
    ...
    <ResponseField name="PSData.ps" type="int" required>
