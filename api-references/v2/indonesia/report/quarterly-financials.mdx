...
api: "GET /v2/financials/quarterly/{ticker}/"
...
<ParamField path="ticker" type="string" required>
  ...
  <AccordionGroup>
    <Accordion title="Get the available ticker">
      Get the available `ticker` from the [Quarterly Financial Dates of a Company](../helper-list/company-quarterly-dates/) endpoint.
    </Accordion>
...
<ParamField query="report_date" type="string">
  ...
  <AccordionGroup>
    ...
    <Accordion title="Get the available report_date">
      Get the available `report_date` from the [Quarterly Financial Dates of a Company](../helper-list/company-quarterly-dates/) endpoint.
    </Accordion>
...
<ParamField query="n_quarters" type="integer">
...
<ResponseField name="operating_cash_flow" type="number">
...
<ResponseField name="current_liabilities" type="number">
...
<ResponseField name="operating_pnl" type="number">
...
<ResponseField name="financials_sector_metrics" type="object">
  ...
  <ResponseField name="non_interest_bearing_liabilities" type="number">
