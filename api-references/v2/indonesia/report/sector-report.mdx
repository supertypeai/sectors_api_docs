...
api: "GET /v2/subsector/report/{sub_sector}/"
...
<ParamField path="pk" type="string" required>
  The primary key (slug) of the subsector for which the report is to be
  retrieved.
  <AccordionGroup>
    ...
    <Accordion title="Format">
      The API endpoint only accepts `pk` in the **kebab case** format (lowercase
      and separated by "-").
    </Accordion>
  </AccordionGroup>
</ParamField>
