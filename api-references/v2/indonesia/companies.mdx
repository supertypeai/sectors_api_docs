...
<ParamField query="q" type="string">
  ...
  <Accordion title="Query Capabilities & Logic">
    ...
    - Note for Enhanced Accuracy: For the most precise results, we recommend filtering by specific sectors or industries using our standardized slugs. You can retrieve the complete list of official slugs from [Subsectors](./helper-list/subsectors), [Subindustries](./helper-list/subindustries), or [Industries](./helper-list/industries).
  </Accordion>
</ParamField>
