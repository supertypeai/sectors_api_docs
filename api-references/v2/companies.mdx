...
<ParamField query="q" type="string">
  ...
  <Accordion title="Query Capabilities & Logic">
    - **Smart FY Handling**: From January to April, queries for the current year automatically default to data from two years prior (e.g., a 2026 query pulls 2024 data). This ensures your results rely on finalized, audited reports rather than incomplete filings.
