...
<ParamField query="q" type="string">
  ...
  <Accordion title="Query Capabilities & Logic">
    - **Smart FY Handling**: In early months (Jan-Apr), queries for the current year (e.g., "2025") automatically default to the previous year's full data (e.g., 2024) to ensure results, as new data is often sparse.
    - **Ownership & Affiliates**: Queries about ownership or associations (e.g., "companies owned by Prajogo Pangestu") exhaustively check `affiliates`, `key_executives`, `executives_shareholdings`, and `major_shareholders`.
    - **Sector Awareness**: The model is aware of all 33 distinct sub-sectors and top 30 industries/sub-industries, allowing for precise categorization filters.
  </Accordion>
</ParamField>
